...
const TemperatureDetails = (tempDetails) => {
  ...
  const [tempValue, setTempValue] = useState(tempDetails.main.temp);
  const [feelLikeTempValue, setFeelsLikeTempValue] = useState(
    tempDetails.main.feels_like
  );
  const [maxTemp, setMaxTemp] = useState(tempDetails.main.temp_max);
  const [minTemp, setMinTemp] = useState(tempDetails.main.temp_min);
